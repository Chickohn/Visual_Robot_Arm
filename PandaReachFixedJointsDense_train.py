...
env_id = 'My_PandaReachFixedJointsDense'
log_dir = './my_test_tensorboard/'
...
model = DDPG(policy="MultiInputPolicy", env=env, learning_rate=1e-3, buffer_size=1000000, batch_size=2048,
...
model.learn(total_timesteps=total_timesteps, tb_log_name='DDPG_reach')
